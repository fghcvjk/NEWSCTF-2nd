...
<div class="container">
    ...
    <div class="card text-center">
        ...
        <div class="card-body">
            ...
            <div class="form-group hidden" extent="radio-fake-page">
                <label for="input-fake-page">URL</label>
                <input  class="form-control" id="input-fake_page" placeholder="Url">
            </div>
